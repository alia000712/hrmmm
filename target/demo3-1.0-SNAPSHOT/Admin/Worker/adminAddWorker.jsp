...
<form action="" method="post">
    <div class="register">
        <center>
            ...
            <input type="text" name="workername" placeholder="Worker Name"><br><br>
            <input type="text" name="workeric" placeholder="Worker IC"><br><br>
            <input type="text" name="workerphone" placeholder="Worker Phone"><br><br>
            <input type="text" name="workeremail" placeholder="Worker Email"><br><br>
            <textarea cols="37" rows="2" name="workeraddress" placeholder="Worker Address"></textarea><br><br>
